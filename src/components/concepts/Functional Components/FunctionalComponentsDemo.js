    ...
    return(
        <Container className='main'>
            ...
            <Col xs='12'>
                ...
                <dl>
                    <dt>Can use state</dt>
                    <dd>With the 'useState hook, functional components can now both render a display to the 
                    ...
                    <dd>With the 'useEffect' hook, functional components can perform side effects with any props 
                        or state changes.
                    </dd>
                    <dt>return()</dt>
